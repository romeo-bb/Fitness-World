...
const Faqs = () => {
  const [list, setList] = useState([
    {
      question:
        "What is the recommended frequency for cardiovascular exercise?",
      answer:
    ...
    {
      question: "Why is strength training important for overall fitness?",
      answer:
        "Strength training helps increase muscle mass, boost metabolism, improve bone density, and enhance overall functional fitness. It also plays a crucial role in injury prevention and supports better joint health.",
    },
    {
      question: "How can one prevent muscle soreness after a workout?",
      answer:
        "To minimize muscle soreness, it's important to engage in proper warm-up and cool-down activities, stay hydrated, ensure adequate protein intake, gradually increase workout intensity, and consider techniques like foam rolling and stretching.",
    },
    {
      question:
        "What is the role of flexibility in a well-rounded fitness routine?",
      answer:
        "Flexibility is crucial for maintaining joint health, preventing injuries, and improving overall functional movement. Incorporating activities like yoga or stretching exercises can enhance flexibility and range of motion.",
    },
    {
      question: "How does nutrition contribute to fitness goals",
      answer:
        "Nutrition is a key component of fitness as it provides the body with the energy and nutrients needed for optimal performance and recovery. A well-balanced diet supports muscle growth, fat loss, and overall health, complementing the effects of regular exercise.",
    },
  ]);

  return (
    <div className="h-auto w-full flex justify-center mt-28">
      <div className="container h-auto min-w-[355px]">
        <div className="mb-20 relative">
          ...
          <img
            src={RedTitle}
            alt="text_bg"
            className="w-[14rem] absolute top-[-8px] left-[-40px]"
          />
        ...
        <div className="flex lg:flex-row xsm:flex-col gap-7 mt-20">
          <div className="lg:w-[45%] w-full lg:mt-16">
            <svg
            ...
            >
              ...
              <ellipse
                ...
                fill="#ffb8b8"
              ></ellipse>
              <rect y="442.00977" width="520" height="2" fill="#3f3d56"></rect>
              <path
